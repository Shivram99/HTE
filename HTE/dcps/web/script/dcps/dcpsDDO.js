function filterDesig() {
	...
	form.setAttribute("action", "ifms.htm?actionFlag=loadDdoEmpDeselction");

	var inputcmbDept = document.createElement("input");
	inputcmbDept.setAttribute("type", "hidden");
	inputcmbDept.setAttribute("name", "Designation");
	inputcmbDept.setAttribute("value", desig);
			...
			if (xmlHttp.status == 200) {
				...
				if (successFlag == 'true') {
					...
					if (successFlagForArrearsApproval == 'true') {
						...
						var form = document.createElement("form");
						form.setAttribute("method", "POST");
						form.setAttribute("action", "ifms.htm?actionFlag=loadDdoEmpDeselction&elementId=700033");
...
function showEmpSelectionList() {
	...
	var form = document.createElement("form");
	form.setAttribute("method", "POST");
	form.setAttribute("action", "ifms.htm?actionFlag=loadDdoEmpSelection&elementId=700032");

	var inputSevaarth = document.createElement("input");
	inputSevaarth.setAttribute("type", "hidden");
	inputSevaarth.setAttribute("name", "txtSevaarthId");
	inputSevaarth.setAttribute("value", txtSevaarthId);

	var inputEmp = document.createElement("input");
	inputEmp.setAttribute("type", "hidden");
	inputEmp.setAttribute("name", "txtEmployeeName");
	inputEmp.setAttribute("value", txtEmployeeName);

	var inputSearch = document.createElement("input");
	inputSearch.setAttribute("type", "hidden");
	inputSearch.setAttribute("name", "requestForSearch");
	inputSearch.setAttribute("value", "Yes");

	form.appendChild(inputSevaarth);
...
function showEmpDeSelectionList() {
	...
	inputDsgn.setAttribute("name", "Designation");
	inputDsgn.setAttribute("value", "-2");
	
	var inputElementId = document.createElement("input");
	inputElementId.setAttribute("type", "hidden");
	inputElementId.setAttribute("name", "elementId");
	inputElementId.setAttribute("value", "700033");
	...
	var inputSearch = document.createElement("input");
	inputSearch.setAttribute("type", "hidden");
	inputSearch.setAttribute("name", "fromSearch");
	inputSearch.setAttribute("value", "Yes");

	form.appendChild(inputDsgn);
	form.appendChild(inputElementId);
	form.appendChild(inputSevaarth);
	form.appendChild(inputEmp);
	form.appendChild(inputSearch);
...
function showAllForDeSelection() {
	...
	inputelement.setAttribute("value", "700033");
