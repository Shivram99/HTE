function SearchEmployee() {
	...
	form.setAttribute("action", "ifms.htm?actionFlag=searchForBrokenPay");

	// Create and configure hidden input elements
	var inputSearchName = document.createElement("input");
	inputSearchName.setAttribute("type", "hidden");
	inputSearchName.setAttribute("name", "txtSearchName");
	inputSearchName.setAttribute("value", searchName);

	var inputYear = document.createElement("input");
	inputYear.setAttribute("type", "hidden");
	inputYear.setAttribute("name", "yearId");
	inputYear.setAttribute("value", yearId);

	var inputMonth = document.createElement("input");
	inputMonth.setAttribute("type", "hidden");
	inputMonth.setAttribute("name", "monthId");
	inputMonth.setAttribute("value", monthId);

	// Append the hidden inputs to the form
	form.appendChild(inputSearchName);
