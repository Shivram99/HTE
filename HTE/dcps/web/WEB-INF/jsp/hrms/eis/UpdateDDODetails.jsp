...
<hdiits:form name="frmEmpStatistics" action="" id="frmEmpStatistics"
	...
	<fieldset class="tabstyle">
		<legend>Existing DDO Details.</legend>
		<br />
		<table>
			<tr>

				<td width="15%" align="left"><fmt:message key="CMN.DDONAME"
						bundle="${commonLables}"></fmt:message></td>
				<td width="20%" align="left"><input type="text" id="txtName"
					size="30" maxlength="99" disabled="disabled" name="txtName"
					value="${ExistingDDODetails}" /> <label class="mandatoryindicator"
					${varLabelDisabled}> *</label></td>
			</tr>

			<tr>
				<td width="15%" align="left"><fmt:message key="CMN.FROMDATE"
						bundle="${commonLables}"></fmt:message></td>
				<td width="20%" align="left"><input type="text"
					...
					disabled="disabled" value="${ExistingDDoFromDate}" /><label
					class="mandatoryindicator" ${varLabelDisabled}> *</label></td>

				<td width="15%" align="left"><fmt:message key="CMN.TODATE"
						bundle="${commonLables}"></fmt:message></td>
				<td width="20%" align="left"><input type="text"
	...
	<br />
	<fieldset class="tabstyle">
		<legend>Update DDO Details.</legend>
		<br />
		<table>
			<tr>
				...
				<td width="15%" align="left"><fmt:message key="CMN.DDONAME"
						bundle="${commonLables}"></fmt:message></td>
				<td width="20%" align="left"><input type="text"
					id="updatedtxtName" size="30" maxlength="99"
					onblur="isName(this,'This field should not contain any special characters or digits.');"
					name="updatedtxtName" /> <label class="mandatoryindicator"
					${varLabelDisabled}> *</label></td>
			</tr>
			...
			<tr>
				<td width="15%" align="left"><fmt:message key="CMN.FROMDATE"
						bundle="${commonLables}"></fmt:message></td>
				<td width="20%" align="left"><input type="text"
					name="updatedtxtFromDate" id="updatedtxtFromDate" maxlength="10"
					onBlur="chkValidDate(this);"
				...
				<td width="15%" align="left"><fmt:message key="CMN.TODATE"
						bundle="${commonLables}"></fmt:message></td>
				<td width="20%" align="left"><input type="text"
					name="updatedtxtTodate" id="updatedtxtTodate" maxlength="10"
					onBlur="chkValidDate(this);"
					onkeypress="digitFormat(this);dateFormat(this);" /><img
					src='images/CalendarImages/ico-calendar.gif' width='20'
					onClick='window_open("txtBirthDate",375,570)'
...
<ajax:autocomplete source="txtDdocode" target="txtDdocode"
	baseUrl="ifms.htm?actionFlag=getDdoCodeForAutoComplete"
	parameters="searchKey={txtDdocode}" className="autocomplete"
	minimumCharacters="4" indicator="roleIndicatorRegion" />
