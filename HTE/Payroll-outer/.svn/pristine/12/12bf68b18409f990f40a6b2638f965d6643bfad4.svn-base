 ...
 */
public class TrnMedblHdrDAOImpl extends
		GenericDaoHibernateImpl<TrnMedblHdr, Long> implements TrnMedblHdrDAO {

	public TrnMedblHdrDAOImpl(Class<TrnMedblHdr> type,
