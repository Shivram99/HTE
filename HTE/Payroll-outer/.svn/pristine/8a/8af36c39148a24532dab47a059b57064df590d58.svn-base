 ...
 */
public class TrnMedblDtlsDAOImpl extends
		GenericDaoHibernateImpl<TrnMedblDtls, Long> implements TrnMedblDtlsDAO {

	public TrnMedblDtlsDAOImpl(Class<TrnMedblDtls> type,
