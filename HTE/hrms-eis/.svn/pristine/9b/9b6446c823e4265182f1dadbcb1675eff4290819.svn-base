...
public class EmpPaybillLoanVO {
	...
	/**
	 * @return the loanSancOrderNo
	 */
	public String getLoanSancOrderNo() {
		return loanSancOrderNo;
	}
	/**
	 * @param loanSancOrderNo the loanSancOrderNo to set
	 */
	...
	/**
	 * @return the loanActivateFlag
	 */
	public int getLoanActivateFlag() {
		return loanActivateFlag;
	}
	/**
	 * @param loanActivateFlag the loanActivateFlag to set
	 */
	public void setLoanActivateFlag(int loanActivateFlag) {
		this.loanActivateFlag = loanActivateFlag;
	}
	/**
	 * @return the loanOddinstno
	 */
	public long getLoanOddinstno() {
		return loanOddinstno;
	}
	/**
	 * @param loanOddinstno the loanOddinstno to set
	 */
	public void setLoanOddinstno(long loanOddinstno) {
		this.loanOddinstno = loanOddinstno;
	}
	/**
	 * @return the loanOddinstAmt
	 */
	public long getLoanOddinstAmt() {
		return loanOddinstAmt;
	}
	/**
	 * @param loanOddinstAmt the loanOddinstAmt to set
	 */
