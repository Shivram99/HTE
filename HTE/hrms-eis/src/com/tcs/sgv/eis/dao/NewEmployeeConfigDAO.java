...
public interface NewEmployeeConfigDAO extends GenericDao{

	public ArrayList getSelectedPosts(long selPostId,long langId,long locId);
	public ArrayList getConfiguredEmpData(long userPostRltId,long langId,long locId,long proofTypeId);
